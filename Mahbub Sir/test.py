...
def sjf_scheduler(processes):
    ...
    while remaining_processes:
        ...
        entry_time, completion_time = next_process.run(current_time)
...
def plot_gantt_chart(gantt_entries):
    ...
    plt.legend()
    plt.title("Gantt Chart - SJF Scheduling")
    plt.show()
...
if __name__ == "__main__":
    ...
    with concurrent.futures.ProcessPoolExecutor() as executor:
        completed_processes, gantt_chart_entries = sjf_scheduler(processes)
